...
for(i in 1:m){
  output[[i]] = lmer(Sec1Total ~ Time +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
...
for(i in 1:m){
outputRegNoPoly[[i]] = lmer(Sec1Total ~ Time +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
}
...
for(i in 1:m){
  output[[i]] = lmer(Sec1Total ~ Time*Edu +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
  outputReg[[i]] = output[[i]]
  rSquared[[i]] = r.squaredGLMM(output[[i]])
  output[[i]] = summary(output[[i]])
  coef_output[[i]] = output[[i]]$coefficients[,1]
...
for(i in 1:m){
  output[[i]] = lmer(Sec1Total ~ Time*Gender +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
  outputReg[[i]] = output[[i]]
  rSquared[[i]] = r.squaredGLMM(output[[i]])
  output[[i]] = summary(output[[i]])
  coef_output[[i]] = output[[i]]$coefficients[,1]
...
for(i in 1:m){
  output[[i]] = lmer(Sec1Total ~ Time*Age +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
  outputReg[[i]] = output[[i]]
  rSquared[[i]] = r.squaredGLMM(output[[i]])
  output[[i]] = summary(output[[i]])
  coef_output[[i]] = output[[i]]$coefficients[,1]
...
for(i in 1:m){
  output[[i]] = lmer(Sec1Total ~ Time*Race +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
  outputReg[[i]] = output[[i]]
  rSquared[[i]] = r.squaredGLMM(output[[i]])
  output[[i]] = summary(output[[i]])
  coef_output[[i]] = output[[i]]$coefficients[,1]
...
for(i in 1:m){
  output[[i]] = lmer(Sec2Total ~ Time +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
  outputReg[[i]] = output[[i]]
  rSquared[[i]] = r.squaredGLMM(output[[i]])
  output[[i]] = summary(output[[i]])
  coef_output[[i]] = output[[i]]$coefficients[,1]
...
outputRegNoPoly = list()
for(i in 1:m){
outputRegNoPoly[[i]] = lmer(Sec2Total ~ Time +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
}
...
for(i in 1:m){
  output[[i]] = lmer(Sec2Total ~ Time*Edu +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
  outputReg[[i]] = output[[i]]
  rSquared[[i]] = r.squaredGLMM(output[[i]])
  output[[i]] = summary(output[[i]])
  coef_output[[i]] = output[[i]]$coefficients[,1]
...
for(i in 1:m){
  output[[i]] = lmer(Sec2Total ~ Time*Gender +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
  outputReg[[i]] = output[[i]]
  rSquared[[i]] = r.squaredGLMM(output[[i]])
  output[[i]] = summary(output[[i]])
  coef_output[[i]] = output[[i]]$coefficients[,1]
...
for(i in 1:m){
  output[[i]] = lmer(Sec2Total ~ Time*Age +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
  outputReg[[i]] = output[[i]]
  rSquared[[i]] = r.squaredGLMM(output[[i]])
  output[[i]] = summary(output[[i]])
  coef_output[[i]] = output[[i]]$coefficients[,1]
...
for(i in 1:m){
  output[[i]] = lmer(Sec2Total ~ Time*Race +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
  outputReg[[i]] = output[[i]]
  rSquared[[i]] = r.squaredGLMM(output[[i]])
  output[[i]] = summary(output[[i]])
  coef_output[[i]] = output[[i]]$coefficients[,1]
...
for(i in 1:m){
  output[[i]] = lmer(Sec3Total ~ Time +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
  outputReg[[i]] = output[[i]]
  rSquared[[i]] = r.squaredGLMM(output[[i]])
  output[[i]] = summary(output[[i]])
  coef_output[[i]] = output[[i]]$coefficients[,1]
...
outputRegNoPoly = list()
for(i in 1:m){
outputRegNoPoly[[i]] = lmer(Sec3Total ~ Time +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
}
...
for(i in 1:m){
  output[[i]] = lmer(Sec3Total ~ Time*Edu +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
  outputReg[[i]] = output[[i]]
  rSquared[[i]] = r.squaredGLMM(output[[i]])
  output[[i]] = summary(output[[i]])
  coef_output[[i]] = output[[i]]$coefficients[,1]
...
for(i in 1:m){
  output[[i]] = lmer(Sec3Total ~ Time*Gender +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
  outputReg[[i]] = output[[i]]
  rSquared[[i]] = r.squaredGLMM(output[[i]])
  output[[i]] = summary(output[[i]])
  coef_output[[i]] = output[[i]]$coefficients[,1]
...
for(i in 1:m){
  output[[i]] = lmer(Sec3Total ~ Time*Age +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
  outputReg[[i]] = output[[i]]
  rSquared[[i]] = r.squaredGLMM(output[[i]])
  output[[i]] = summary(output[[i]])
  coef_output[[i]] = output[[i]]$coefficients[,1]
...
for(i in 1:m){
  output[[i]] = lmer(Sec3Total ~ Time*Race +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
  outputReg[[i]] = output[[i]]
  rSquared[[i]] = r.squaredGLMM(output[[i]])
  output[[i]] = summary(output[[i]])
  coef_output[[i]] = output[[i]]$coefficients[,1]
...
for(i in 1:m){
  output[[i]] = lmer(Sec4Total ~ Time +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
  outputReg[[i]] = output[[i]]
  rSquared[[i]] = r.squaredGLMM(output[[i]])
  output[[i]] = summary(output[[i]])
  coef_output[[i]] = output[[i]]$coefficients[,1]
...
outputRegNoPoly = list()
for(i in 1:m){
outputRegNoPoly[[i]] = lmer(Sec4Total ~ Time +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
}
...
for(i in 1:m){
  output[[i]] = lmer(Sec4Total ~ Time*Edu +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
  outputReg[[i]] = output[[i]]
  rSquared[[i]] = r.squaredGLMM(output[[i]])
  output[[i]] = summary(output[[i]])
  coef_output[[i]] = output[[i]]$coefficients[,1]
...
for(i in 1:m){
  output[[i]] = lmer(Sec4Total ~ Time*Gender +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
  outputReg[[i]] = output[[i]]
  rSquared[[i]] = r.squaredGLMM(output[[i]])
  output[[i]] = summary(output[[i]])
  coef_output[[i]] = output[[i]]$coefficients[,1]
...
for(i in 1:m){
  output[[i]] = lmer(Sec4Total ~ Time*Age +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
  outputReg[[i]] = output[[i]]
  rSquared[[i]] = r.squaredGLMM(output[[i]])
  output[[i]] = summary(output[[i]])
  coef_output[[i]] = output[[i]]$coefficients[,1]
...
for(i in 1:m){
  output[[i]] = lmer(Sec4Total ~ Time*Race +  Edu + Gender + Age + Race + (1 | ID), data  = datAnalysisAllPrePost[[i]])
  outputReg[[i]] = output[[i]]
  rSquared[[i]] = r.squaredGLMM(output[[i]])
  output[[i]] = summary(output[[i]])
  coef_output[[i]] = output[[i]]$coefficients[,1]
